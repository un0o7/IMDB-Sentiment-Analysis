...
def test():
    ...
    f1 = f1_score(real_labels, pred_labels, average='binary')
    precision = precision_score(real_labels, pred_labels, average='binary')
    recall = recall_score(real_labels, pred_labels, average='binary')
